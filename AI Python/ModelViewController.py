...
class ChatbotApp:
    def __init__(self):
        ...
        self.user_chat_window = tk.Frame(
            self.chat_frame,
            borderwidth=0,
            highlightthickness=0,
            highlightbackground="#DDD",
        ...
        self.input_field = tk.Entry(
            self.input_frame, width=40, font=self.message_font, bg="#4A6F89", fg="white"
        )
    ...
    def handle_input(self):
        ...
        user_message_frame.pack(
            side=tk.TOP, fill=tk.BOTH, padx=10, pady=(0, 10), anchor=tk.NE
        )
        ...
        bot_message_frame = tk.Frame(
            self.bot_chat_window,
            borderwidth=0,
            highlightthickness=0,
            highlightbackground="#DDD",
            relief="groove",
        ...
        bot_message_frame.pack(
            side=tk.TOP, fill=tk.BOTH, padx=10, pady=(10, 10), anchor=tk.NW
        )

        bot_message_label = tk.Label(
            bot_message_frame,
            text="...",
            font=self.message_font,
            bg="#5B8DB0",
        ...
        self.root.after(
            1000, lambda: self.display_bot_response(bot_response, bot_message_label)
        )
